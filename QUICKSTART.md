...
- [Quick Start — Portfolio Site](#quick-start--portfolio-site)
  ...
  - [6. Work page &amp; projects](#6-work-page--projects)
    ...
    - [Hover preview video (1–2 flagship projects)](#hover-preview-video-12-flagship-projects)
    - [Hide a project from the grid](#hide-a-project-from-the-grid)
    - [Case study layout](#case-study-layout)
